    ...
    <main className="bg-background min-h-screen pb-20 font-sans selection:bg-naranja-light selection:text-white">
      ...
      <div className="container mx-auto px-4 mt-5 space-y-8">
        ...
        <section className="bg-white rounded-[2.5rem] shadow-xl overflow-hidden border border-gray-100">
          <div id="residuos" className="bg-naranja p-8 text-white">
            <div className="flex items-center gap-4 mb-2">
              <Trash2 size={32} />
              <h3 className="text-xl md:text-3xl font-black italic uppercase">Recolección de Residuos</h3>
            </div>
            <p className="text-orange-100 font-medium">Cronograma detallado de Residuos Secos</p>
          </div>
